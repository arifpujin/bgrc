...
<body style="text-align:center">
            ...
            <div class="error">
                <div class="container-floud">
                    <div class="col-xs-12 ground-color text-center">
                        ...
                        <h2 class="h1">Sorry! This Page not Respond<br>
                        </h2>
                    </div>
                </div>
            </div>
        <!-- Error Page -->
        <footer>
        Looks like a temporary glitch in our code or network has part of system down<br>
        So there's no need for you to do a thing<br><br><br>
        IT Department BGRC
        </footer>
</body>
<script>
