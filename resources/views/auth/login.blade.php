                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="auth-box">
                                <div class="row m-b-20">
                                    <div class="col-md-12">
                                        <h3 class="text-left txt-primary">Exit Pass</h3>
                                    </div>
                                </div>
                                <hr/>
                                <div class="input-group">
                                    <input id="username" type="text" maxlength="5" class="form-control" placeholder="Employee ID" name ="username" value="{{ old('username') }}" required autofocus>
