                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                ...
                                                <div class="d-inline">
                                                    ...
                                                    <span>Tabel Data Semua Exitpass Bukit Gambang Resort City</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="dt-responsive table-responsive">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$dexitps->hod_status}}<br>{{$dexitps->apr_name}} {{$dexitps->hod_date}} {{$dexitps->hod_time}}</td>
                                                            ...
                                                            @empty
                                                            <tr>    
                                                                <td colspan="7" style="text-align: center;"><b><i>TIDAK ADA DATA UNTUK DITAMPILKAN</i></b></td>
                                                            </tr>
                                                            @endforelse
                                                        </tbody>      
                                                            </table>
