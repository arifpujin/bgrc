                                        ...
                                        <div class="col-lg-8">
                                            <div class="page-header-title">
                                                ...
                                                <div class="d-inline">
                                                    ...
                                                    <span>Pengisian Form untuk staff Exitpass</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                <div class="card-header">
                                                    ...
                                                    <span>Isikan Form dengan Baik dan Benar</span>
                                                ...
                                                <div class="card-block">
                                                    ...
                                                    <form role="form" method="POST" action="{{ url('admin/regisuser') }}">
                                                    {{ csrf_field() }}
                                                        ...
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">ID Employee</label>
                                                            <div class="col-sm-10">
                                                                <input id="username" type="text" class="form-control"
                                                                       placeholder="ID Employee" name="username" maxlength="5" value="{{ old('username') }}">
