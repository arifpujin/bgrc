                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-block">
                                                    <h4 class="sub-title">New Department</h4>
                                                    <form role="form" method="POST" action="{{ url('hod-hr/newdep') }}">
                                                    {{ csrf_field() }}
                                                        <div class="form-group row">
                                                            <label class="col-sm-2 col-form-label">Name Depatment</label>
                                                            <div class="col-sm-10">
                                                                <input id="name" type="text" name="name" class="form-control"
                                                                       placeholder="Name Department" maxlength="50">
                                                                @if ($errors->has('name'))
                                            ...
                                            <div class="card-block">
                                                <div class="table-responsive dt-responsive">
                                                    ...
                                                    <thead>
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    <form method="post" action="{{url('hod-hr/depedit')}}">
                                                                        {{ csrf_field() }}
                                                                        <div class="col-sm-8">
                                                                        <input id="name" type="text" name="name" class="form-control" placeholder="Name Department" maxlength="50" value="{{$d->name}}">
                                                                        </div>
                                                                </td>
                                                                <td><div class="col-sm-3">
                                                                    ...
                                                                    <form method="post" action="{{url('hod-hr/depdel')}}">
                                                                    {{ csrf_field() }}
                                                                        <input type="hidden" name="id" value="{{$d->id}}">
                                                                        <div class="btn-group btn-group-sm" style="float: none;">
                                                            ...
                                                            @empty
                                                            <tr>    
                                                                <td colspan="2" style="text-align: center;"><b><i>NO DATA SHOWN</i></b></td>
                                                            </tr>
                                                            @endforelse
                                                        </tbody>
                                                    </table>
