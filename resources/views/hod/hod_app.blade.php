                                                ...
                                                <div class="table-responsive dt-responsive">
                                                    ...
                                                    <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{$DA->tipe}}</td>
                                                                <td>{{$DA->purpose}}</td>
                                                                <td>{{$DA->hod_status}}<br>{{$DA->apr_name}} {{$DA->hod_date}} {{$DA->hod_time}}</td>
                                                                <td>Name Police : {{$DA->name_police_out}}<br>{{$DA->date_out}} {{$DA->time_out}}</td>
                                                                <td>Name Police : {{$DA->name_police_in}}<br>{{$DA->date_in}} {{$DA->time_in}}</td>
                                                            </tr>
                                                            @empty
                                                            <tr>    
